...
InvolvedPersonMelted <- melt(InvolvedPerson,id.vars = "DATE")
 ...
 ggplot(InvolvedPersonMelted)+geom_line(aes(DATE,value,col= variable))+
  ...
  scale_colour_solarized("red",guide = guide_legend(title = "Count Statistic"))+
  ggtitle("Trend Of Collision With Statisical Summary")+
  ylab("No of person killed | person injured | collision")+
